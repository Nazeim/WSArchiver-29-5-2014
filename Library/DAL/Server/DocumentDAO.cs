...
namespace Library.DAL.Server
{
    class DocumentDAO : DAO<DocumentVO>, Interface.IDocumentDAO
    {
        ...
        public const string documentOutDate = "documentOutDate";
        public const string documentOutNumber = "documentOutNumber";
        ...
        protected override SqlParameter[] MakeSqlParameters(DocumentVO vo)
        {
        ...
        public List<DocumentVO> FindByOutNumber(int OutNumber)
        {
            return FindByIntegerColumn(OutNumber, documentOutNumber);
        }
