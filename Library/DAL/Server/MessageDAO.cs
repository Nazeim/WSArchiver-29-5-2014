...
{
    class MessageDAO : DAO<MessageVO>, IMessageDAO
    {
        ...
        protected override SqlParameter[] MakeSqlParameters(MessageVO vo)
        {
        ...
        public override MessageVO ReadRecord(SqlDataReader reader)
        {
